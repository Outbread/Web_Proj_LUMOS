...
function ReviewDetail() {
    ...
    const onClickReviewUpdateHandler = () => {        
        ...
        navigate(`/review/${reviewDetail.pdCode}`, { replace: true});
                        ...
                        <tr>
                            ...
                            <td>
                                <input  
                                    ...
                                    style={!modifyMode ? { backgroundColor: 'gray' } : null}
                                    onchange={ onChangeHandler }
                                    value={ (!modifyMode ? reviewDetail.pdGrade : form.pdGrade) || ''}
                                />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input  
                                    ...
                                    value={ reviewDetail && reviewDetail.member?.memberName || ''}
                                />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input 
                                    ...
                                    readOnly={true}
                                    style={ { backgroundColor: 'gray'} }
                                    value={ reviewDetail && reviewDetail.uploadDate || ''}
                                />
                            </td>
                        </tr>
                        <tr>
