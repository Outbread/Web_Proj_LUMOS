...
COMMENT ON COLUMN TBL_OPTION.OPTION_NM IS '옵션명';

COMMENT ON COLUMN TBL_OPTION.OPTION_STOCK IS '재고수량';

COMMENT ON COLUMN TBL_OPTION.PD_CODE IS '상품코드';

COMMENT ON TABLE TBL_OPTION IS '옵션정보';
