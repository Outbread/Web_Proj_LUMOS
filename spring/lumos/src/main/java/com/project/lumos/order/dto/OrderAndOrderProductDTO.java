...
public class OrderAndOrderProductDTO {
	...
	public OrderAndOrderProductDTO() {
	}

	public OrderAndOrderProductDTO(int orderNum, String orderCode, Date orderDate, String paymentMt, int orderPc,
