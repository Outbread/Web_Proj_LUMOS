...
@SequenceGenerator(
	...
	public QuestionMemberAndImg(int questionCode, String questionTitle, String questionCategory, String questionContent,
			String answerContent, String questionStatus, int memberCode, String questionCreateDate, Member member,
	...
	public QuestionMemberAndImg() {
		super();
	}

	@Override
	public String toString() {
		return "QuestionMemberAndImg [questionCode=" + questionCode + ", questionTitle=" + questionTitle
				...
				+ ", questionCreateDate=" + questionCreateDate + ", member=" + member + ", questionImg=" + questionImg
				+ "]";
	}
