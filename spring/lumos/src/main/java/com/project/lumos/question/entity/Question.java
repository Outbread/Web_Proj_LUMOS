...
public class Question {
	...
	public Question(int questionCode, String questionTitle, String questionCategory, String questionContent,
	...
	public String toString() {
		return "Question [questionCode=" + questionCode + ", questionTitle=" + questionTitle + ", questionCategory="
				+ questionCategory + ", questionContent=" + questionContent + ", answerContent=" + answerContent
				+ ", questionStatus=" + questionStatus + ", memberCode=" + memberCode + ", questionCreateDate="
				+ questionCreateDate + "]";
	}
