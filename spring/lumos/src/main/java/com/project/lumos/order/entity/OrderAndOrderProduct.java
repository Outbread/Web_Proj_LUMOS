...
public class OrderAndOrderProduct {
	...
	public OrderAndOrderProduct() {
	}

	public OrderAndOrderProduct(int orderNum, String orderCode, Date orderDate, String paymentMt, int orderPc,
